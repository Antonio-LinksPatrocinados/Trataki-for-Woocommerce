 ...
 * also set variable allowed on 0 to disable submit button on step 1 of configurationF
 */
$versions = array (
					...
					<td>
                                                <label class="woo-product-feed-pro-switch">
                                                        ...
                                                        if(isset($project['product_variations'])){
                                                                ...
                                                                print "<input type=\"checkbox\" id=\"variations\" name=\"product_variations\" class=\"checkbox-field\" checked>"; //Antonio
                                                        }
                                                        ?>
				...
				<tr>
					...
					<td>
						...
						if((isset($project)) AND (array_key_exists('products_changed',$project))){
							...
							print "<input name=\"products_changed\" type=\"checkbox\" class=\"checkbox-field\" checked>"; // Antonio
						}
						?>
					</td>
				</tr>
